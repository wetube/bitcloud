...
- Be paid for guarantied storage.
- Store non-guarantied content based on popular acceptance.
...
#+BEGIN_SRC lisp
   ...
   (verdict f :penalization 1.3 :ban 6)
#+END_SRC

The first var is *t* or *f* indicating if the verdict is favorable or
